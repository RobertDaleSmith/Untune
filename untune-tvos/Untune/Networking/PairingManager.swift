...
class PairingManager {
    ...
    func pair(host: String, port: UInt16, code: String) async throws {
        ...
        let body: [String: String] = ["code": code, "deviceName": "Apple TV (\(deviceName))"]
    ...
    func authToken() -> String? {
        readKeychainValue(key: "com.untune.tvos.pairing-token")
    }

    // MARK: - Keychain

    private func saveToKeychain(token: String, deviceId: String, desktopName: String, baseURL: String) {
        setKeychainValue(key: "com.untune.tvos.pairing-token", value: token)
        setKeychainValue(key: "com.untune.tvos.device-id", value: deviceId)
        setKeychainValue(key: "com.untune.tvos.desktop-name", value: desktopName)
        setKeychainValue(key: "com.untune.tvos.base-url", value: baseURL)
    }

    private func loadFromKeychain() {
        if let token = readKeychainValue(key: "com.untune.tvos.pairing-token"),
           let devId = readKeychainValue(key: "com.untune.tvos.device-id"),
           let name = readKeychainValue(key: "com.untune.tvos.desktop-name"),
           let url = readKeychainValue(key: "com.untune.tvos.base-url"),
           !token.isEmpty {
    ...
    private func deleteFromKeychain() {
        deleteKeychainValue(key: "com.untune.tvos.pairing-token")
        deleteKeychainValue(key: "com.untune.tvos.device-id")
        deleteKeychainValue(key: "com.untune.tvos.desktop-name")
        deleteKeychainValue(key: "com.untune.tvos.base-url")
    }
